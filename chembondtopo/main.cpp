                                              ...
                                              char **ErrMsg)             /* OUT (only if returning FALSE) */
{
     ...
     * Example:
     *
     * $!ADDONCOMMAND ADDONID='Chemistry Bond Topology' COMMAND='MYCOMMAND'
     */
...
/**
 */
static void STDCALL oldDialogMenuCallback(void)
{
    TecUtilLockStart(AddOnID);
...
/**
 */
static void STDCALL newSidebarMenuCallback(void)
{
    TecUtilLockStart(AddOnID);

    if ( TecUtilDataSetIsAvailable() &&
         TecUtilDataSetGetNumZones() > 1 &&
...
void STDCALL registerMenuCallbacks(void)
{
#if 1
    TecUtilMenuAddOption("Tools",
        "Chemistry Bond Topology",
        '\0',
        oldDialogMenuCallback);
#endif
    TecUtilMenuAddOption("Tools",
        "Bondalyzer",
        'B',
        newSidebarMenuCallback);
}
